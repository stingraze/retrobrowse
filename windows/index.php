 ...
 */ 
    ...
    const BASIC_AUTH_PASSWORD	= '1234'; 
 
function challengeAuthentication(): void { 
    if (REQUIRE_BASIC_AUTH) { 
        /* test for username/password */ 
        if( ! ( isset($_SERVER['PHP_AUTH_USER'] ) && ( $_SERVER['PHP_AUTH_USER'] == BASIC_AUTH_USER ) ) AND 
          ( isset($_SERVER['PHP_AUTH_PW'] ) && ( $_SERVER['PHP_AUTH_PW'] == BASIC_AUTH_PASSWORD )) ) 
        { 
